      ...
      <Box sx={{ py: 3 }}>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
          <Tabs value={tabValue} onChange={handleTabChange}>
            ...
            <Tab label="Analysis Results" disabled={!enhancementResults} />
            <Tab label="Enhancement Preview" disabled={!enhancementResults} />
            <Tab label="Interactive Dashboard" disabled={!enhancementResults} />
            <Tab label="Diagrams" disabled={!enhancementResults} />
            <Tab label="Change Report" disabled={!enhancementResults} />
            <Tab label="Modernization" disabled={!enhancementResults} />
          </Tabs>
        </Box>
